...
router.post("/:id/analyze", rateLimiter_1.llmLimiter, resume_validator_1.validateAnalyzeResume, validate_middleware_1.handleValidationErrors, resume_controller_1.resumeController.analyzeResume);
